...
class ZoosControllerTest < ActionController::TestCase
  ...
  test "should create zoo" do
    assert_difference('Zoo.count') do
      post :create, zoo: { description: @zoo.description, location: @zoo.location, name: @zoo.name }
    end
  ...
  test "should update zoo" do
    patch :update, id: @zoo, zoo: { description: @zoo.description, location: @zoo.location, name: @zoo.name }
    assert_redirected_to zoo_path(assigns(:zoo))
  end
